...
sn.csv <- read.csv("D:\Downloads\Ex_Files_UaR_R\Ex_Files_UaR_R\Exercise Files\Ch02\02_04\social_network.csv", header = T)
...
sn.spss.csv <- read.csv("D:\\Downloads\\Ex_Files_UaR_R\\Ex_Files_UaR_R\\Exercise Files\\Ch02\\02_04\\social_network.csv", header = T)
str(sn.spss.csv)
...
library(foreign)
sn.spss.f <- read.spss("D:\\Downloads\\Ex_Files_UaR_R\\Ex_Files_UaR_R\\Exercise Files\\Ch02\\02_04\\social_network.sav", to.data.frame=T, use.value.labels=T)
str(sn.spss.f)
